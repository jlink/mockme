...
var IdentityHash = Class.create({
	...
	set: function(key, value) {
		...
		if (entry === undefined) {
			this._entries.addFirst({key: key, value: value});
		} else {
			entry.value = value;
		}
	},
...
var MockedFunction = {
	...
	thenReturn: function(value) {
		this._stubCurrentCall(function() {return value});
	},
	...
	thenThrow: function(ex) {
		this._stubCurrentCall(function() {throw ex});
	},
...
var times = function(times) {
	...
	f.toString = function() {return times};
	return f;
}
...
var atLeast = function(times) {
	...
	f.toString = function() {return 'at least ' + times};
	return f;
}
...
var isOfType = function(type) {
	return {
		match: function(obj) {return (typeof(obj) == type)},
		toString: function() {return 'isOfType(' + type + ')'}
	};
};
...
var isInstanceOf = function(constructor) {
	...
	return {
		match: function(obj) {return (obj instanceof constructor)},
		toString: function() {return 'isInstanceOf(aConstructor)'}
	};
};

var isSame = function(expectedObj) {
	return {
		match: function(obj) {return (expectedObj === obj)},
		toString: function() {return 'isSame(' + expectedObj + ')'}
	};
};
